...
(function (Donaldsfarm) {
    ...
    function load() {
        ...
        let cow = new Animal("Cow", "MUUH", "Weed", 200, 50);
        console.log(cow.text());
        console.log(cow.eat());
        let horse = new Animal("Horse", "PPRRR", "Apple", 50, 15);
        console.log(horse.text());
        console.log(horse.eat());
        let chicken = new Animal("Chicken", "BogBog", "Corn", 100, 25);
        console.log(chicken.text());
        console.log(chicken.eat());
        let dog = new Animal("Dog", "Wuff", "Meat", 20, 5);
        console.log(dog.text());
        console.log(dog.eat());
        let sheep = new Animal("Sheep", "Määäh", "Straw", 200, 80);
